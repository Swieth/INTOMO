function [gmfh,gmfw] = gmf (dmjd,dlat,dlon,dhgt,zd)
...
% dhgt: height in m
% zd:   zenith distance in radians [90 - elev]
% 
% output data
% -----------
% gmfh: hydrostatic mapping function ztd = [shd/gmfh]
% gmfw: wet mapping function zwd = [swd/gmfw]
% 
...
doy = dmjd  - 44239 + 1 - 28;   %  mjd=44239 corresponds to January 1, 1980, since it doesn't matter which January 1 ist taken; - 28 is correct!
...
ah  = (ahm + aha*cos(doy/365.25*2*pi))*1d-5;
...
aw =  (awm + awa*cos(doy/365.25*2*pi))*1d-5;
