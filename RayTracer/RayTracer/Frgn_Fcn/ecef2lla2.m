function lla = ecef2lla2( p, varargin )
...
%      lla = ecef2lla2( [ 4510731 4510731 0 ] )
%
%   Determine latitude, longitude and altitude at multiple coordinates
%   specifying WGS84 ellipsoid model:
%      lla = ecef2lla2( [ 4510731 4510731 0; 0 4507609 4498719 ], 'WGS84' )
%
%   Determine latitude, longitude and altitude at multiple coordinates
%   specifying custom ellipsoid model:
%      f = 1/196.877360;
%      Re = 3397000;
%      lla = ecef2lla2( [ 4510731 4510731 0; 0 4507609 4498719 ],  f, Re )
%
...
[f,R] = worldparams2(nargin, varargin);
