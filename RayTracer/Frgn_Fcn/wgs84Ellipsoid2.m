function e = wgs84Ellipsoid2(lengthUnit)
...
if isempty(wgs84EllipsoidInMeters)
    wgs84EllipsoidInMeters = referenceEllipsoid('wgs84');
end

e = wgs84EllipsoidInMeters;
if nargin > 0
    e.LengthUnit = validateLengthUnit2(lengthUnit,mfilename,'LENGTHUNIT',1);
end
